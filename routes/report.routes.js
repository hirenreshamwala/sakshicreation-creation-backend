...
router.post("/getqpinactive-parties-paginated", ReportController.getqpInactivePartiesPaginated);
router.post("/getscinactive-parties", ReportController.getscOrderInactiveParties);
router.post("/getscinactive-parties-paginated", ReportController.getscInactivePartiesPaginated);
